        ...
        <div>
            <div className="mb-8 max-w-3xl">
                ...
                <p className="mt-3 text-sm leading-relaxed text-muted-foreground sm:text-base">
                    Editorial listening for slower discovery: trusted selections, staff picks, and the stations people return to when taste matters more than volume.
                </p>
            </div>
            {!search && (
                    ...
                    <>
                        ...
                        {loadingSearch ? (
                            ...
                            <div className="py-24 text-center">
                                ...
                                <p className="mt-1 text-xs text-muted-foreground">Try Explore for wider filtering and discovery.</p>
                            </div>
                        ) : (
                            <>
                                <div className="grid grid-cols-3 gap-2 sm:grid-cols-4 lg:grid-cols-5">
                            ...
                            <div className="mb-10">
                                <div className="mb-4 flex items-center gap-2">
                                    ...
                                    <h2 className="ui-section-title">
                                        {feedView === 'staff-picks' ? 'Staff Picks' : 'Editor’s Selection'}
                                    </h2>
                                </div>
                                {loadingRecommended ? (
                        ...
                        {(feedView === 'for-you' || feedView === 'trending') && (
                            <div>
                                <div className="mb-4 flex items-center gap-2">
                                    ...
                                    <h2 className="ui-section-title">
                                        {feedView === 'trending' ? 'Trending Now' : 'Most Played'}
                                    </h2>
                                </div>
                                {loadingMostPlayed ? (
                                    <div className="grid grid-cols-3 gap-2 sm:grid-cols-7">
