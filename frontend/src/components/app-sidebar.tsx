      ...
      {settingsSections.map(({ section, label, icon: Icon }) => {
        ...
        return (
          <Link
            ...
            className={cn(
              'mb-1 flex items-center gap-3.5 rounded-lg px-4 py-2 text-[1.05rem] transition-colors',
              active
          ...
          {mainNavItems.map(({ href, icon: Icon, label }) => {
            ...
            return (
              <Link
                ...
                prefetch
                className={cn(
                  'mb-1 flex items-center gap-3.5 rounded-lg px-4 py-2.5 text-[1.05rem] transition-colors',
                  active
